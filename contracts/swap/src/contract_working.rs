...
pub fn query(deps: Deps, _env: Env, msg: QueryMsg) -> StdResult<Binary> {
    match msg {
        ...
        //     query_and_debug::<QueryEpochsInfoResponse>(&deps, QueryNumPoolsRequest {})
        // }
        // QueryMsg::QueryEpochsInfo {} => {
        //     query_and_debug::<QueryEpochsInfoResponse>(&deps, QueryEpochsInfoRequest {})
        // }
        QueryMsg::QueryPool { pool_id } => {
            query_and_debug(&deps, QueryPoolRequest { pool_id })
        }
        QueryMsg::QueryPoolParams { pool_id } => {
            query_and_debug(&deps, QueryPoolParamsRequest { pool_id })
        }
        // QueryMsg::QueryPoolParams { pool_id } => {
...
//     T: Serialize + DeserializeOwned + Debug,
{
    ...
    to_binary(&{
        ...
        let res: QueryPoolResponse = match deps.querier.raw_query(&raw) {
